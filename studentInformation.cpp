...
Title=Department maintains student information. The file contains roll number, name, division and address. Allow user to add, delete information of student. Display information of particular employee. If record of student does not exist an appropriate message is displayed. If it is, then the system displays the student details. Use sequential file to main the data.*/
...
/*OUTPUT=
        *** Student Information ***
        ...
        Enter a Name of Student : Atharva

        Enter a Division of Student : B

        Enter a Address of Student : India 

        Do You Want to Add More Records: y

        Enter Roll No of Student : 30

        Enter a Name of Student : Sid

        Enter a Division of Student : B 

        Enter a Address of Student : USA
